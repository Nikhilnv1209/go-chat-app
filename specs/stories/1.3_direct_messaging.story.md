...
## Acceptance Criteria
- [ ] **AC1** [T03.01]: Online recipient receives message instantly.
- [ ] **AC2** [T03.02]: Offline recipient has message saved in DB.
- [ ] **AC3**: `Conversation.last_message_at` is updated.
- [ ] **AC4**: `Conversation.unread_count` increments for receiver.
