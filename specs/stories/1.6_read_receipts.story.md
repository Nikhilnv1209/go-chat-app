...
## Acceptance Criteria
- [ ] **AC1** [T06.01]: When a message is sent, a receipt with status SENT is created.
- [ ] **AC2** [T06.02]: When receiver's client acknowledges delivery, status updates to DELIVERED.
- [ ] **AC3** [T06.03]: When receiver marks message as read, status updates to READ and sender is notified.
- [ ] **AC4**: Receipt status is queryable via `GET /messages/:id/receipts`.
