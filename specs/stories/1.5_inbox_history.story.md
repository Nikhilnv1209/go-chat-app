...
## Acceptance Criteria
- [ ] **AC1**: Returns correct list of DMs and Groups sorted by `last_message_at`.
- [ ] **AC2**: History loads in reverse chronological order.
- [ ] **AC3**: Pagination works (using `before_id`).
