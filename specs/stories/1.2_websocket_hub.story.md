...
## Acceptance Criteria
- [ ] **AC1** [T02.01]: Connection without token returns 401.
- [ ] **AC2** [T02.02]: Valid token upgrades connection (101).
- [ ] **AC3** [T02.03]: Server responds to Ping with Pong.
- [ ] **AC4** [T02.04]: On disconnect, `last_seen` timestamp is updated.
